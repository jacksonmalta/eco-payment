...
func transactionWithContext(ctx context.Context, body io.ReadCloser, log Logger, a app.Debit) (*TransactionErrorResponse, error) {
	defer body.Close()
	...
	if res != nil && res.Error && res.Code == app.OperationTypeInvalid {
